...
cd "\${startdir}"
EOM
    echodebug "Wrote file ${fn}"

    fn="${_lxc_shared_dir}/env.sh"
    touch "${fn}"
    chmod o+rwx "${fn}"
    cat >> "${fn}" <<- EOM
#!/bin/sh -
